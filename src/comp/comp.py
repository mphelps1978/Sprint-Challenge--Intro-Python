...
c = [name.name for name in humans if name.name.startswith('C') or name.name.startswith(
    'D') or name.name.startswith('E') or name.name.startswith('F') or name.name.startswith('G')]
print(c)
